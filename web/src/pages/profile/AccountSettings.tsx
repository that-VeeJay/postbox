    ...
    <Sheet>
      ...
      <SheetContent>
        <SheetHeader>
          ...
          <SheetDescription>
            Update your account details here. Don't forget to save your changes
        ...
        <form onSubmit={handleSubmit}>
          <div className="space-y-5 px-5">
            ...
            <SheetDescription>
              Deleting your account will permanently remove all data. Please
              download any information you want to keep beforehand.
            </SheetDescription>
            <Dialog>
